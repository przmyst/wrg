...
# direct methods
.method constructor <init>(Landroid/content/Context;Lr/d;Landroidx/emoji2/text/i$a;)V
    .locals 1
    ...
    .line 4
    invoke-static {p2, v0}, Lu/e;->g(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;
    ...
    .line 6
    iput-object p2, p0, Landroidx/emoji2/text/i$b;->b:Lr/d;
...
.method private e()Lr/f$b;
    ...
    iget-object v2, p0, Landroidx/emoji2/text/i$b;->b:Lr/d;

    invoke-virtual {v0, v1, v2}, Landroidx/emoji2/text/i$a;->b(Landroid/content/Context;Lr/d;)Lr/f$a;
    ...
    .line 3
    invoke-virtual {v0}, Lr/f$a;->b()[Lr/f$b;
...
.method c()V
    ...
    .line 5
    :try_start_1
    invoke-direct {p0}, Landroidx/emoji2/text/i$b;->e()Lr/f$b;

    move-result-object v0

    .line 6
    invoke-virtual {v0}, Lr/f$b;->b()I
    ...
    .line 9
    invoke-static {v1}, Lq/c;->a(Ljava/lang/String;)V
    ...
    invoke-virtual {v1, v2, v0}, Landroidx/emoji2/text/i$a;->a(Landroid/content/Context;Lr/f$b;)Landroid/graphics/Typeface;
    ...
    .line 12
    invoke-virtual {v0}, Lr/f$b;->d()Landroid/net/Uri;

    move-result-object v0

    .line 13
    invoke-static {v2, v3, v0}, Lm/l;->f(Landroid/content/Context;Landroid/os/CancellationSignal;Landroid/net/Uri;)Ljava/nio/ByteBuffer;
