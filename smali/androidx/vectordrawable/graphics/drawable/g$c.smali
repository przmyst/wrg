...
.method constructor <init>(Landroidx/vectordrawable/graphics/drawable/g$c;)V
    ...
    .line 22
    iget-object v0, p1, Landroidx/vectordrawable/graphics/drawable/g$c;->f:Ll/d;

    iput-object v0, p0, Landroidx/vectordrawable/graphics/drawable/g$c;->f:Ll/d;
    ...
    .line 25
    iget-object v0, p1, Landroidx/vectordrawable/graphics/drawable/g$c;->h:Ll/d;

    iput-object v0, p0, Landroidx/vectordrawable/graphics/drawable/g$c;->h:Ll/d;
...
.method private h(Landroid/content/res/TypedArray;Lorg/xmlpull/v1/XmlPullParser;Landroid/content/res/Resources$Theme;)V
    ...
    .line 2
    invoke-static {p2, v0}, Ll/i;->j(Lorg/xmlpull/v1/XmlPullParser;Ljava/lang/String;)Z
    ...
    .line 6
    invoke-static {v0}, Lm/d;->d(Ljava/lang/String;)[Lm/d$b;

    move-result-object v0

    iput-object v0, p0, Landroidx/vectordrawable/graphics/drawable/g$f;->a:[Lm/d$b;
    ...
    .line 7
    invoke-static/range {v1 .. v6}, Ll/i;->e(Landroid/content/res/TypedArray;Lorg/xmlpull/v1/XmlPullParser;Landroid/content/res/Resources$Theme;Ljava/lang/String;II)Ll/d;
    ...
    invoke-static {p1, p2, v2, v0, v1}, Ll/i;->f(Landroid/content/res/TypedArray;Lorg/xmlpull/v1/XmlPullParser;Ljava/lang/String;IF)F
    ...
    .line 9
    invoke-static {p1, p2, v1, v0, v2}, Ll/i;->g(Landroid/content/res/TypedArray;Lorg/xmlpull/v1/XmlPullParser;Ljava/lang/String;II)I
    ...
    iput-object p3, p0, Landroidx/vectordrawable/graphics/drawable/g$c;->f:Ll/d;
    ...
    invoke-static {p1, p2, v1, p3, v0}, Ll/i;->f(Landroid/content/res/TypedArray;Lorg/xmlpull/v1/XmlPullParser;Ljava/lang/String;IF)F
    ...
    invoke-static {p1, p2, v1, p3, v0}, Ll/i;->g(Landroid/content/res/TypedArray;Lorg/xmlpull/v1/XmlPullParser;Ljava/lang/String;II)I
...
.method public a()Z
    ...
    iget-object v0, p0, Landroidx/vectordrawable/graphics/drawable/g$c;->h:Ll/d;

    invoke-virtual {v0}, Ll/d;->i()Z

    move-result v0

    if-nez v0, :cond_1

    iget-object v0, p0, Landroidx/vectordrawable/graphics/drawable/g$c;->f:Ll/d;
...
.method public b([I)Z
    ...
    invoke-virtual {v0, p1}, Ll/d;->j([I)Z

    move-result v0

    .line 2
    iget-object v1, p0, Landroidx/vectordrawable/graphics/drawable/g$c;->f:Ll/d;

    invoke-virtual {v1, p1}, Ll/d;->j([I)Z
...
.method public g(Landroid/content/res/Resources;Landroid/util/AttributeSet;Landroid/content/res/Resources$Theme;Lorg/xmlpull/v1/XmlPullParser;)V
    ...
    invoke-static {p1, p3, p2, v0}, Ll/i;->k(Landroid/content/res/Resources;Landroid/content/res/Resources$Theme;Landroid/util/AttributeSet;[I)Landroid/content/res/TypedArray;
